...
# -----------------------------
# File paths
data_file = "system.txt"   # <--- NEW INPUT FILE
topology_file = "topology.txt"
output_file = "input_polymer_translocation.txt"
# -----------------------------
...
# Example box
xlo, xhi = 0.0, 14.769394404940591
ylo, yhi = 0.0, 14.769497835581483
zlo, zhi = 0.0, 43.711310009943
